# AGENTS.md — Руководство для AI-агентов по коду

> Универсальные инструкции для AI-агентов по написанию кода (Claude Code, Aider, OpenCode, Cursor, Codex и др.). Если вы AI-агент — прочитайте этот файл первым, затем прочитайте директорию `docs/` — это единый источник истины о проекте.
